...
KEY_ISR:        PUSH {R0-R7, LR}
				LDR		 R1, =0xFF200050         // R1 stores the address to KEY base
                LDR      R2, [R1, #0xC]         // R2 stores the edge capture
                MOV      R3, #0xF
                STR      R3, [R1, #0xC]         // Reset the edge capture
                LDR      R1, =0xFF200020        // base address of HEX3-HEX0
                //MOV      R9, #BIT_CODES         // Store addess of the bit codes
				B		 KEY_ZERO
